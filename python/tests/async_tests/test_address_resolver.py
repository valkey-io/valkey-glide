...
"""
Tests for async client address resolver functionality.
...
class TestAddressResolver:
    """Async address resolver tests."""

    async def test_address_resolver_with_fake_address(self, cluster_mode: bool):
        """
        ...
        try:
            ...
            assert await client.set("resolver_test_key", "resolver_test_value") == OK
            assert await client.get("resolver_test_key") == b"resolver_test_value"
        finally:
            await client.close()

    async def test_address_resolver_exception_falls_back_to_original(
    ...
    async def test_address_resolver_returns_none_falls_back_to_original(
        self, cluster_mode: bool
    ):
        """
