...
import pytest
from .protobuf.command_request_pb2 import CommandRequest, RequestType
from .protobuf.response_pb2 import Response
from .protobuf_codec import PartialMessageException, ProtobufCodec
