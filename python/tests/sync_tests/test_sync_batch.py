...
def batch_test(
    ...
    helper4(
        batch, glide_sync_client, key8, key10, key13, key14, key15, key19, key20, args
    )

    helper5(batch, glide_sync_client, key11, key12, key17, key18, key20, args)
...
def helper5(transaction, glide_sync_client, key11, key12, key17, key18, key20, args):
    if not sync_check_if_server_version_lt(glide_sync_client, "7.0.0"):
...
def helper4(
    transaction, glide_sync_client, key8, key10, key13, key14, key15, key19, key20, args
):
    ...
    if not sync_check_if_server_version_lt(glide_sync_client, "6.0.0"):
...
class TestSyncBatch:
    ...
    def test_sync_cluster_batch(self, glide_sync_client: GlideClusterClient, is_atomic):
        ...
        expected = batch_test(batch, glide_sync_client, keyslot)
    ...
    def test_sync_standalone_batch(
        ...
        expected = batch_test(transaction, glide_sync_client, keyslot)
