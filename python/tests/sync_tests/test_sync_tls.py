...
class TestSyncTls:
    ...
    @pytest.mark.parametrize("cluster_mode", [True, False])
    @pytest.mark.parametrize("protocol", [ProtocolVersion.RESP2, ProtocolVersion.RESP3])
    def test_client_fails_if_client_cert_path_provided_but_key_path_not_provided(
        self, request, cluster_mode: bool, protocol: ProtocolVersion
    ):
        server_certificate = get_ca_certificate()
    ...
    @pytest.mark.parametrize("cluster_mode", [True, False])
    @pytest.mark.parametrize("protocol", [ProtocolVersion.RESP2, ProtocolVersion.RESP3])
    def test_client_fails_if_client_key_path_provided_but_cert_path_not_provided(
        self, request, cluster_mode: bool, protocol: ProtocolVersion
    ):
        server_certificate = get_ca_certificate()
    ...
    @pytest.mark.parametrize("cluster_mode", [True, False])
    @pytest.mark.parametrize("protocol", [ProtocolVersion.RESP2, ProtocolVersion.RESP3])
    def test_client_fails_if_cert_reload_enabled_without_paths(
        self, request, cluster_mode: bool, protocol: ProtocolVersion
    ):
        server_certificate = get_ca_certificate()
    ...
    @pytest.mark.parametrize("cluster_mode", [True, False])
    @pytest.mark.parametrize("protocol", [ProtocolVersion.RESP2, ProtocolVersion.RESP3])
    def test_client_inits_with_client_cert_and_key_paths(
        self, request, cluster_mode: bool, protocol: ProtocolVersion
    ):
        server_certificate = get_ca_certificate()
    ...
    @pytest.mark.parametrize("cluster_mode", [True, False])
    @pytest.mark.parametrize("protocol", [ProtocolVersion.RESP2, ProtocolVersion.RESP3])
    def test_client_inits_with_cert_reload_enabled(
        self, request, cluster_mode: bool, protocol: ProtocolVersion
    ):
