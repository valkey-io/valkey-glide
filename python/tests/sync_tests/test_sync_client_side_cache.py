...
from tests.utils.utils import get_random_string, sync_wait_for
...
class TestSyncClientSideCache:
    ...
    def test_sync_server_assisted_defaults_to_false(self):
        ...
        cache = ClientSideCache.create(max_cache_kb=1024)
    ...
    def test_sync_server_assisted_can_be_set_to_true(self):
        ...
        cache = ClientSideCache.create(max_cache_kb=1024, server_assisted=True)
    ...
    def test_sync_server_assisted_can_be_explicitly_set_to_false(self):
        ...
        cache = ClientSideCache.create(max_cache_kb=1024, server_assisted=False)
        assert cache.server_assisted is False
