...
def get_ca_certificate() -> bytes:
    ...
    The certificate is at utils/tls_crts/ca.crt, relative to the repository root.
    ...
    ca_cert_path = os.path.join(file_path, "..", "..", "..", "utils", "tls_crts", "ca.crt")
...
def get_client_certificate() -> bytes:
    ...
    The certificate is at utils/tls_crts/server.crt, relative to the repository root.
    This file is automatically generated when TLS clusters are started.
    """
    import os
    ...
    file_path = os.path.dirname(__file__)
    ca_cert_path = os.path.join(file_path, "..", "..", "..", "utils", "tls_crts", "server.crt")
...
def get_client_key() -> bytes:
    ...
    The certificate is at utils/tls_crts/server.key, relative to the repository root.
    This file is automatically generated when TLS clusters are started.
    """
    import os
    from glide_shared.config import load_client_certificate_from_file
    ...
    file_path = os.path.dirname(__file__)
    ca_cert_path = os.path.join(file_path, "..", "..", "..", "utils", "tls_crts", "server.key")
