...
> **lcs**(`key1`, `key2`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **lcsIdx**(`key1`, `key2`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **objectIdletime**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pexpireTime**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pfadd**(`key`, `elements`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pfcount**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pfmerge**(`destination`, `sourceKeys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **ping**(`message`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pttl**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **publish**(`message`, `channel`, `sharded`): [`ClusterTransaction`](ClusterTransaction.md)
...
| `sharded` | `boolean` | `false` | Use sharded pubsub mode. Available since Valkey version 7.0. Command Response - Number of subscriptions in primary node that received the message. |
...
> **pubsubChannels**(`pattern`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pubsubNumPat**(): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pubsubNumSub**(`channels`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **pubsubShardChannels**(`pattern`?): [`ClusterTransaction`](ClusterTransaction.md)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `pattern`? | [`GlideString`](../../BaseClient/type-aliases/GlideString.md) | A glob-style pattern to match active shard channels. If not provided, all active shard channels are returned. Command Response - A list of currently active shard channels matching the given pattern. If no pattern is specified, all active shard channels are returned. |
...
[https://valkey.io/commands/pubsub-shardchannels\|valkey.io](https://valkey.io/commands/pubsub-shardchannels|valkey.io) for more details.

***

### pubsubShardNumSub()

> **pubsubShardNumSub**(`channels`): [`ClusterTransaction`](ClusterTransaction.md)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `channels` | [`GlideString`](../../BaseClient/type-aliases/GlideString.md)[] | The list of shard channels to query for the number of subscribers. Command Response - A list of the shard channel names and their numbers of subscribers. |
...
[https://valkey.io/commands/pubsub-shardnumsub\|valkey.io](https://valkey.io/commands/pubsub-shardnumsub|valkey.io) for more details.
...
> **randomKey**(): [`ClusterTransaction`](ClusterTransaction.md)
...
> **rename**(`key`, `newKey`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **renamenx**(`key`, `newKey`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **restore**(`key`, `ttl`, `value`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)

Create a `key` associated with a `value` that is obtained by deserializing the provided
serialized `value` (obtained via [dump](ClusterTransaction.md#dump)).
...
> **rpop**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **rpopCount**(`key`, `count`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **rpush**(`key`, `elements`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **rpushx**(`key`, `elements`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sadd**(`key`, `members`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **scard**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sdiff**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sdiffstore**(`destination`, `keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **set**(`key`, `value`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **setbit**(`key`, `offset`, `value`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **setrange**(`key`, `offset`, `value`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sinter**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sintercard**(`keys`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sinterstore**(`destination`, `keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sismember**(`key`, `member`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **smembers**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **smismember**(`key`, `members`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **smove**(`source`, `destination`, `member`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sort**(`key`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
To store the result into a new key, see [sortStore](ClusterTransaction.md#sortstore).
...
> **sortReadOnly**(`key`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sortStore**(`key`, `destination`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
To get the sort result without storing it into a key, see [sort](ClusterTransaction.md#sort) or [sortReadOnly](ClusterTransaction.md#sortreadonly).
...
> **spop**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **spopCount**(`key`, `count`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **srandmember**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **srandmemberCount**(`key`, `count`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **srem**(`key`, `members`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sscan**(`key`, `cursor`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **strlen**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sunion**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **sunionstore**(`destination`, `keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **time**(): [`ClusterTransaction`](ClusterTransaction.md)
...
> **touch**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **ttl**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **type**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **unlink**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)

Removes the specified keys. A key is ignored if it does not exist.
This command, similar to [del](ClusterTransaction.md#del), removes specified keys and ignores non-existent ones.
...
> **wait**(`numreplicas`, `timeout`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xack**(`key`, `group`, `ids`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xadd**(`key`, `values`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xautoclaim**(`key`, `group`, `consumer`, `minIdleTime`, `start`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xautoclaimJustId**(`key`, `group`, `consumer`, `minIdleTime`, `start`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xclaim**(`key`, `group`, `consumer`, `minIdleTime`, `ids`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xclaimJustId**(`key`, `group`, `consumer`, `minIdleTime`, `ids`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xdel**(`key`, `ids`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xgroupCreate**(`key`, `groupName`, `id`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xgroupCreateConsumer**(`key`, `groupName`, `consumerName`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xgroupDelConsumer**(`key`, `groupName`, `consumerName`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xgroupDestroy**(`key`, `groupName`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xgroupSetId**(`key`, `groupName`, `id`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xinfoConsumers**(`key`, `group`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xinfoGroups**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xinfoStream**(`key`, `fullOptions`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xlen**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xpending**(`key`, `group`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xpendingWithOptions**(`key`, `group`, `options`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xrange**(`key`, `start`, `end`, `count`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xread**(`keys_and_ids`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xreadgroup**(`group`, `consumer`, `keys_and_ids`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **xrevrange**(`key`, `end`, `start`, `count`?): [`ClusterTransaction`](ClusterTransaction.md)

Returns stream entries matching a given range of entry IDs in reverse order. Equivalent to [xrange](ClusterTransaction.md#xrange) but returns the
...
> **xtrim**(`key`, `options`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zadd**(`key`, `membersAndScores`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zaddIncr**(`key`, `member`, `increment`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zcard**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zcount**(`key`, `minScore`, `maxScore`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zdiff**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)

Returns the difference between the first sorted set and all the successive sorted sets.
To get the elements with their scores, see [zdiffWithScores](ClusterTransaction.md#zdiffwithscores).
...
> **zdiffstore**(`destination`, `keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zdiffWithScores**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zincrby**(`key`, `increment`, `member`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zinter**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)

Computes the intersection of sorted sets given by the specified `keys` and returns a list of intersecting elements.
To get the scores as well, see [zinterWithScores](ClusterTransaction.md#zinterwithscores).
...
> **zintercard**(`keys`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zinterstore**(`destination`, `keys`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zinterWithScores**(`keys`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
To get the elements only, see [zinter](ClusterTransaction.md#zinter).
To store the result in a key as a sorted set, see zinterStore.
...
> **zlexcount**(`key`, `minLex`, `maxLex`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zmpop**(`keys`, `modifier`, `count`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zmscore**(`key`, `members`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zpopmax**(`key`, `count`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zpopmin**(`key`, `count`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrandmember**(`key`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrandmemberWithCount**(`key`, `count`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrandmemberWithCountWithScores**(`key`, `count`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrange**(`key`, `rangeQuery`, `reverse`): [`ClusterTransaction`](ClusterTransaction.md)

Returns the specified range of elements in the sorted set stored at `key`.
`ZRANGE` can perform different types of range queries: by index (rank), by the score, or by lexicographical order.

To get the elements with their scores, see [zrangeWithScores](ClusterTransaction.md#zrangewithscores).
...
> **zrangeStore**(`destination`, `source`, `rangeQuery`, `reverse`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrangeWithScores**(`key`, `rangeQuery`, `reverse`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrank**(`key`, `member`): [`ClusterTransaction`](ClusterTransaction.md)

Returns the rank of `member` in the sorted set stored at `key`, with scores ordered from low to high.
To get the rank of `member` with its score, see [zrankWithScore](ClusterTransaction.md#zrankwithscore).
...
> **zrankWithScore**(`key`, `member`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrem**(`key`, `members`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zremRangeByLex**(`key`, `minLex`, `maxLex`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zremRangeByRank**(`key`, `start`, `end`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zremRangeByScore**(`key`, `minScore`, `maxScore`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zrevrank**(`key`, `member`): [`ClusterTransaction`](ClusterTransaction.md)

Returns the rank of `member` in the sorted set stored at `key`, where
scores are ordered from the highest to lowest, starting from `0`.
To get the rank of `member` with its score, see [zrevrankWithScore](ClusterTransaction.md#zrevrankwithscore).
...
> **zrevrankWithScore**(`key`, `member`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zscan**(`key`, `cursor`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zscore**(`key`, `member`): [`ClusterTransaction`](ClusterTransaction.md)
...
> **zunion**(`keys`): [`ClusterTransaction`](ClusterTransaction.md)

Computes the union of sorted sets given by the specified `keys` and returns a list of union elements.

To get the scores as well, see [zunionWithScores](ClusterTransaction.md#zunionwithscores).
To store the result in a key as a sorted set, see [zunionstore](ClusterTransaction.md#zunionstore).
...
> **zunionstore**(`destination`, `keys`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)

Computes the union of sorted sets given by the specified `keys` and stores the result in `destination`.
If `destination` already exists, it is overwritten. Otherwise, a new sorted set will be created.
To get the result directly, see [zunionWithScores](ClusterTransaction.md#zunionwithscores).
...
> **zunionWithScores**(`keys`, `options`?): [`ClusterTransaction`](ClusterTransaction.md)

Computes the intersection of sorted sets given by the specified `keys` and returns a list of union elements with scores.
To get the elements only, see [zunion](ClusterTransaction.md#zunion).
