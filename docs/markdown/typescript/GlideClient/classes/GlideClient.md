...
> **configSet**(`parameters`): `Promise`\<`"OK"`\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `sections`? | [`InfoOptions`](../../Commands/enumerations/InfoOptions.md)[] | (Optional) A list of [InfoOptions](../../Commands/enumerations/InfoOptions.md) values specifying which sections of information to retrieve. When no parameter is provided, [Default](../../Commands/enumerations/InfoOptions.md#default) is assumed. |
...
[https://valkey.io/commands/lastsave/\|valkey.io](https://valkey.io/commands/lastsave/|valkey.io) for more details.
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `options`? | [`LolwutOptions`](../../Commands/interfaces/LolwutOptions.md) | (Optional) The LOLWUT options - see [LolwutOptions](../../Commands/interfaces/LolwutOptions.md). |
...
[https://valkey.io/commands/lolwut/\|valkey.io](https://valkey.io/commands/lolwut/|valkey.io) for more details.
...
> **move**(`key`, `dbIndex`): `Promise`\<`boolean`\>
...
| `dbIndex` | `number` | The index of the database to move `key` to. |
...
[https://valkey.io/commands/move/\|valkey.io](https://valkey.io/commands/move/|valkey.io) for more details.
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `options`? | `object` & [`DecoderOption`](../../BaseClient/interfaces/DecoderOption.md) | (Optional) Additional parameters: - (Optional) `message` : a message to include in the `PING` command. + If not provided, the server will respond with `"PONG"`. + If provided, the server will respond with a copy of the message. - (Optional) `decoder`: see [DecoderOption](../../BaseClient/interfaces/DecoderOption.md). |
...
> **publish**(`message`, `channel`): `Promise`\<`number`\>
...
| `channel` | [`GlideString`](../../BaseClient/type-aliases/GlideString.md) | Channel to publish the message on. |
...
[https://valkey.io/commands/randomkey/\|valkey.io](https://valkey.io/commands/randomkey/|valkey.io) for more details.
...
> **scan**(`cursor`, `options`?): `Promise`\<\[[`GlideString`](../../BaseClient/type-aliases/GlideString.md), [`GlideString`](../../BaseClient/type-aliases/GlideString.md)[]\]\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `cursor` | [`GlideString`](../../BaseClient/type-aliases/GlideString.md) | The `cursor` used for iteration. For the first iteration, the cursor should be set to "0". Using a non-zero cursor in the first iteration, or an invalid cursor at any iteration, will lead to undefined results. Using the same cursor in multiple iterations will, in case nothing changed between the iterations, return the same elements multiple times. If the the db has changed, it may result in undefined behavior. |
| `options`? | [`ScanOptions`](../../Commands/interfaces/ScanOptions.md) & [`DecoderOption`](../../BaseClient/interfaces/DecoderOption.md) | (Optional) The options to use for the scan operation, see [ScanOptions](../../Commands/interfaces/ScanOptions.md) and [DecoderOption](../../BaseClient/interfaces/DecoderOption.md). |

#### Returns

`Promise`\<\[[`GlideString`](../../BaseClient/type-aliases/GlideString.md), [`GlideString`](../../BaseClient/type-aliases/GlideString.md)[]\]\>

A List containing the next cursor value and a list of keys,
formatted as [cursor, [key1, key2, ...]]

#### See

[https://valkey.io/commands/scan\|valkey.io](https://valkey.io/commands/scan|valkey.io) for more details.
...
> **scriptExists**(`sha1s`): `Promise`\<`boolean`[]\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `index` | `number` | The index of the database to select. |
...
> `static` **\_\_createClient**(`options`, `connectedSocket`): `Promise`\<[`GlideClient`](GlideClient.md)\>
...
`Promise`\<[`GlideClient`](GlideClient.md)\>
...
> `static` **createClient**(`options`): `Promise`\<[`GlideClient`](GlideClient.md)\>
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `options` | [`GlideClientConfiguration`](../type-aliases/GlideClientConfiguration.md) | The configuration options for the client, including server addresses, authentication credentials, TLS settings, database selection, reconnection strategy, and Pub/Sub subscriptions. |
