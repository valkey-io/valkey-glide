...
public class GlideJniClientTest {
    ...
    public void testEmptyAddressList() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            new GlideJniClient(new GlideJniClient.Config(Collections.emptyList()));
        });
    ...
    public void testNullConfig() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            new GlideJniClient((GlideJniClient.Config) null);
        });
    ...
    public void testConvenienceConstructor() {
        // This should construct without errors - it won't connect to the actual host
        // but the construction itself should work
        assertDoesNotThrow(() -> {
            new GlideJniClient("localhost", 6379);
        });
    }
