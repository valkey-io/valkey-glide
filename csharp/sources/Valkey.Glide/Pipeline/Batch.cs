...
/// <para />
/// Batch Response: An <c>array</c> of command responses is returned by the client <see cref="GlideClient.Exec(Batch)" />
/// and <see cref="GlideClient.Exec(Batch, Options.BatchOptions)" /> API, in the order they were given. Each element
...
/// <inheritdoc cref="GlideClient.Exec(Batch)" path="/remarks/example" />
/// </remarks>
/// <param name="isAtomic">
