...
/// <para />
/// Batch Response: An <c>array</c> of command responses is returned by the client <see cref="GlideClusterClient.Exec(ClusterBatch)" />
/// and <see cref="GlideClusterClient.Exec(ClusterBatch, Options.ClusterBatchOptions)" /> API, in the order they were given.
...
/// </summary>
/// <remarks>
/// <inheritdoc cref="GlideClusterClient.Exec(ClusterBatch)" path="/remarks/example" />
/// </remarks>
/// <param name="isAtomic">
