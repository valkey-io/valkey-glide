...
internal interface ISetCommands
{
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetUnionAsync(ValkeyKey first, ValkeyKey second, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetUnionAsync(ValkeyKey[] keys, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetIntersectAsync(ValkeyKey first, ValkeyKey second, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetIntersectAsync(ValkeyKey[] keys, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetDifferenceAsync(ValkeyKey first, ValkeyKey second, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetDifferenceAsync(ValkeyKey[] keys, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetUnionStoreAsync(ValkeyKey destination, ValkeyKey first, ValkeyKey second, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetUnionStoreAsync(ValkeyKey destination, ValkeyKey[] keys, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetIntersectStoreAsync(ValkeyKey destination, ValkeyKey first, ValkeyKey second, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetIntersectStoreAsync(ValkeyKey destination, ValkeyKey[] keys, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetDifferenceStoreAsync(ValkeyKey destination, ValkeyKey first, ValkeyKey second, CommandFlags ignored = CommandFlags.None);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetDifferenceStoreAsync(ValkeyKey destination, ValkeyKey[] keys, CommandFlags ignored = CommandFlags.None);
}
