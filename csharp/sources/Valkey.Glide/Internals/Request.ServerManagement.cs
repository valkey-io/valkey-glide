...
internal partial class Request
{
    ...
    public static Cmd<GlideString, TimeSpan> PingAsync(CommandFlags flags = CommandFlags.None)
    {
    ...
    public static Cmd<GlideString, TimeSpan> PingAsync(ValkeyValue message, CommandFlags flags = CommandFlags.None)
    {
        Utils.Requires<NotImplementedException>(flags == CommandFlags.None, "Command flags are not supported by GLIDE");
        Stopwatch stopwatch = Stopwatch.StartNew();
    ...
    public static Cmd<GlideString, ValkeyValue> EchoAsync(ValkeyValue message, CommandFlags flags = CommandFlags.None)
    {
        Utils.Requires<NotImplementedException>(flags == CommandFlags.None, "Command flags are not supported by GLIDE");
        GlideString[] args = [message.ToGlideString()];
