...
public class CommandTests
{
    ...
    public void ValidateCommandArgs()
    {
        Assert.Multiple(
            ...
            () => Assert.Equal(["ZADD", "key", "10.5", "member1", "8.2", "member2"], Request.SortedSetAddAsync("key", [new SortedSetEntry("member1", 10.5), new SortedSetEntry("member2", 8.2)]).GetArgs()),
            () => Assert.Equal(["ZADD", "key", "NX", "10.5", "member1", "8.2", "member2"], Request.SortedSetAddAsync("key", [new SortedSetEntry("member1", 10.5), new SortedSetEntry("member2", 8.2)], SortedSetWhen.NotExists).GetArgs()),
