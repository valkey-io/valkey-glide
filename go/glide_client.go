...
// MigrateKeys atomically transfers the specified keys from the source Valkey instance to a destination
// Valkey instance using the multi-key MIGRATE wire format. On success, keys are deleted from the source.
//
// See [valkey.io] for details.
//
// Parameters:
...
func (client *Client) MigrateKeys(
	ctx context.Context,
	host string,
	port int64,
	keys []string,
...
// MigrateKeysWithOptions atomically transfers the specified keys from the source Valkey instance to a
...
//
// [valkey.io]: https://valkey.io/commands/migrate/
func (client *Client) MigrateKeysWithOptions(
	ctx context.Context,
	host string,
	port int64,
	keys []string,
