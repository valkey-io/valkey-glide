...
// Package rustbin_x86_64_apple_darwin exists solely to ensure this directory is included
// when using 'go mod vendor'.
//
// This directory contains libglide_ffi.a, the precompiled Rust FFI library
// for the x86_64-apple-darwin target.
//
...
package rustbin_x86_64_apple_darwin
