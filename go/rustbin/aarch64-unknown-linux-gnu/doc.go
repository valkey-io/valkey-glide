...
// Package rustbin_aarch64_unknown_linux_gnu exists solely to ensure this directory is included
// when using 'go mod vendor'.
//
// This directory contains libglide_ffi.a, the precompiled Rust FFI library
// for the aarch64-unknown-linux-gnu target.
//
...
package rustbin_aarch64_unknown_linux_gnu
