...
func (b *StandaloneBatch) Echo(message string) *StandaloneBatch {
...
func (b *StandaloneBatch) ClientId() *StandaloneBatch {
...
func (b *StandaloneBatch) ClientGetName() *StandaloneBatch {
...
func (b *StandaloneBatch) ClientSetName(connectionName string) *StandaloneBatch {
	return b.addCmdAndTypeChecker(C.ClientSetName, []string{connectionName}, reflect.String, false)
}

// ==========================
// Connection Management Cluster Commands
// ==========================

// Echo the provided message back with routing options.
//
// See [valkey.io] for details.
//
// Parameters:
...
//	routeOptions - Specifies the routing configuration for the command.
//
// Command Response:
//
...
//
// [valkey.io]: https://valkey.io/commands/echo/
func (b *ClusterBatch) EchoWithOptions(message string, routeOptions options.RouteOption) *ClusterBatch {
	// Note: This is a cluster-specific command, so we implement it only for ClusterBatch
	return b.addCmdAndTypeChecker(C.Echo, []string{message}, reflect.String, false)
}

// Gets the current connection id with routing options.
//
// See [valkey.io] for details.
//
// Parameters:
...
//
// [valkey.io]: https://valkey.io/commands/client-id/
func (b *ClusterBatch) ClientIdWithOptions(routeOptions options.RouteOption) *ClusterBatch {
	// Note: This is a cluster-specific command, so we implement it only for ClusterBatch
	return b.addCmdAndTypeChecker(C.ClientId, []string{}, reflect.Int64, false)
}

// Set the name of the current connection with routing options.
//
// See [valkey.io] for details.
//
// Parameters:
...
//
// [valkey.io]: https://valkey.io/commands/client-setname/
func (b *ClusterBatch) ClientSetNameWithOptions(connectionName string, routeOptions options.RouteOption) *ClusterBatch {
	// Note: This is a cluster-specific command, so we implement it only for ClusterBatch
	return b.addCmdAndTypeChecker(C.ClientSetName, []string{connectionName}, reflect.String, false)
}

// Gets the name of the current connection with routing options.
//
// See [valkey.io] for details.
//
// Parameters:
...
//
// [valkey.io]: https://valkey.io/commands/client-getname/
func (b *ClusterBatch) ClientGetNameWithOptions(routeOptions options.RouteOption) *ClusterBatch {
	// Note: This is a cluster-specific command, so we implement it only for ClusterBatch
	return b.addCmdAndTypeChecker(C.ClientGetName, []string{}, reflect.String, true)
}

// Pings the server with cluster routing options.
//
// See [valkey.io] for details.
//
// Parameters:
...
//
// [valkey.io]: https://valkey.io/commands/echo/
func (b *ClusterBatch) Echo(message string) *ClusterBatch {
	return b.addCmdAndTypeChecker(C.Echo, []string{message}, reflect.String, false)
}
...
//
// [valkey.io]: https://valkey.io/commands/client-id/
func (b *ClusterBatch) ClientId() *ClusterBatch {
	return b.addCmdAndTypeChecker(C.ClientId, []string{}, reflect.Int64, false)
}
...
//
// [valkey.io]: https://valkey.io/commands/client-getname/
func (b *ClusterBatch) ClientGetName() *ClusterBatch {
	return b.addCmdAndTypeChecker(C.ClientGetName, []string{}, reflect.String, true)
}
...
//
// [valkey.io]: https://valkey.io/commands/client-setname/
func (b *ClusterBatch) ClientSetName(connectionName string) *ClusterBatch {
	return b.addCmdAndTypeChecker(C.ClientSetName, []string{connectionName}, reflect.String, false)
}
