...
// Parameters:
//
//	route - The route option specifying which node(s) to execute the command on. The client
...
// The mode can be either SYNC or ASYNC. The command will be routed to all nodes.
//
// See [valkey.io] for details.
//
// Parameters:
