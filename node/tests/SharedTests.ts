...
export function runBaseTests<Context>(config: {
    ...
    async function zinterEmptyCases(client: BaseClient) {
        const key1 = "{testKey}:1-" + uuidv4();
    ...
    it.each([ProtocolVersion.RESP2, ProtocolVersion.RESP3])(
        ...
        async (protocol) => {
            await runTest(async (client: BaseClient) => {
                await zinterBasicTest(client);
                await zinterWithScoresBasicTest(client);
                await zinterWithScoresWithMaxAggregation(client);
                await zinterWithScoresWithMinAggregation(client);
                await zinterWithScoresWithSumAggregation(client);
                await zinterWithScoresWithWeightsAndAggregation(client);
                await zinterEmptyCases(client);
            }, protocol);
        },
        config.timeout,
    );
    ...
    async function zunionEmptyCases(client: BaseClient) {
        const key1 = "{testKey}:1-" + uuidv4();
    ...
    it.each([ProtocolVersion.RESP2, ProtocolVersion.RESP3])(
        ...
        async (protocol) => {
            await runTest(async (client: BaseClient) => {
                ...
                await zunionWithScoresBasicTest(client);
                await zunionWithScoresWithMaxAggregation(client);
                await zunionWithScoresWithMinAggregation(client);
                await zunionWithScoresWithSumAggregation(client);
                await zunionWithScoresWithWeightsAndAggregation(client);
                await zunionEmptyCases(client);
            }, protocol);
        },
        config.timeout,
    );
