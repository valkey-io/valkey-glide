...
describe("TLS with custom certificates", () => {
    ...
    beforeAll(async () => {
        // Read CA certificate before creating clusters
        ...
        const tlsServerOptions: TestTLSConfig = {
            useTLS: true,
    ...
    describe("Standalone TLS with certificates", () => {
        ...
        it(
            ...
            async () => {
                ...
                const result = await standaloneClient.set("tls-test-key", "test-value");
    ...
    describe("Cluster TLS with certificates", () => {
        ...
        it(
            ...
            async () => {
                ...
                const result = await clusterClient.set("tls-cluster-key", "test-value");
                expect(result).toBe("OK");
            },
            TIMEOUT,
        );
