...
export class GlideClient extends BaseClient {
     ...
     * @param decoder - An optional parameter to decode all commands in the transaction. If not set, the client decoder default config will be used.
     ...
     * @param decoder - An optional enum parameter for decoding the response.
