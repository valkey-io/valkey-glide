...
const LEVEL: Map<levelOptions | undefined, BabushkaInternal.Level | undefined> =
    new Map([
        ["error", BabushkaInternal.Level.Error],
        ["warn", BabushkaInternal.Level.Warn],
        ["info", BabushkaInternal.Level.Info],
        ["debug", BabushkaInternal.Level.Debug],
        ["trace", BabushkaInternal.Level.Trace],
        [undefined, undefined],
    ]);
...
export class Logger {
    ...
    private constructor(level?: levelOptions, fileName?: string) {
        Logger.logger_level = BabushkaInternal.InitInternalLogger(
            LEVEL.get(level),
            fileName
        );
    }
    ...
    public log(logLevel: levelOptions, logIdentifier: string, message: string) {
        ...
        BabushkaInternal.log(level, logIdentifier, message);
    }
}
