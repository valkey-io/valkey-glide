...
public interface SortedSetBaseCommands {
     ...
     *     even indices and the score is at odd indices. If {@link ZScanOptions#noScores()} is to
     *     <code>true
     ...
     *     Array</code> of the subset of the sorted set held in <code>key</code>. The array in the
     *     second element is a flattened series of <code>String</code> pairs, where the value is at
     *     even indices and the score is at odd indices. If {@link ZScanOptionsBinary#noScores()}
     *     is to <code>true
     *     </code>, the second element will only contain the members without scores.
     * @example
     *     <pre>{@code
