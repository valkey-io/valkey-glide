...
public class ClusterBatchRetryStrategy {
     ...
     * retried.
     *
     * <p><b>Warning:</b> Enabling this flag may cause commands targeting the same slot to execute
     * out of order.
     *
     ...
     *
     * <p><b>Warning:</b> Retrying after a connection error may lead to duplicate executions, since
