...
def build_windows_userdata(
    ...
    lines = [
        ...
        f"    $env:GLIDE_REMOTE_IP = '{linux_private_ip}'",
        f"    $env:GLIDE_REMOTE_REGION = '{REGION}'",
        "    Write-Log \"GLIDE_REMOTE_INSTANCE_ID=$env:GLIDE_REMOTE_INSTANCE_ID GLIDE_REMOTE_IP=$env:GLIDE_REMOTE_IP\"",
        "    [System.Environment]::SetEnvironmentVariable('GLIDE_REMOTE_INSTANCE_ID', $env:GLIDE_REMOTE_INSTANCE_ID, 'Process')",
        "    [System.Environment]::SetEnvironmentVariable('GLIDE_REMOTE_IP', $env:GLIDE_REMOTE_IP, 'Process')",
        "    [System.Environment]::SetEnvironmentVariable('GLIDE_REMOTE_REGION', $env:GLIDE_REMOTE_REGION, 'Process')",
        f"    $testArgs = @('test', '--', '--runInBand', '--forceExit')",
        ...
        f"    $env:GLIDE_REMOTE_IP = '{linux_private_ip}'",
        f"    $env:GLIDE_REMOTE_REGION = '{REGION}'",
        "    $jestEnv = @{ 'GLIDE_REMOTE_INSTANCE_ID' = $env:GLIDE_REMOTE_INSTANCE_ID; 'GLIDE_REMOTE_IP' = $env:GLIDE_REMOTE_IP; 'GLIDE_REMOTE_REGION' = $env:GLIDE_REMOTE_REGION }",
        "    Write-Log \"About to run npm test with GLIDE_REMOTE_INSTANCE_ID=$($jestEnv['GLIDE_REMOTE_INSTANCE_ID'])\"",
