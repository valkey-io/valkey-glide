...
* Node: rename mTLS fields to `clientCertificate`, `clientKey`, `clientCertPath`, `clientKeyPath` so the public surface matches Python, Java, and Go ([#6678](https://github.com/valkey-io/valkey-glide/pull/6678))
