...
* Go: Add `HGETDEL` command support, atomically getting and deleting one or more hash fields (Valkey 9.1+) ([#6145](https://github.com/valkey-io/valkey-glide/issues/6145))
