...
* Java: Add OpenTelemetry span creation for script invocations (`EVALSHA`) so `invokeScript` calls appear in traces with DB semantic convention attributes ([#5600](https://github.com/valkey-io/valkey-glide/issues/5600))
