...
* Core: Scoped connections authenticate as the configured IAM identity instead of running as the server's default user, and no longer send a malformed `AUTH` on IAM token rotation ([#7001](https://github.com/valkey-io/valkey-glide/issues/7001))
