...
* Core/FFI: `create_client_from_uri` now preserves a URI username without a password (e.g. `redis://iam-user@host:6379`), enabling IAM authentication instead of failing with "IAM authentication requires a username" ([#TBD](https://github.com/valkey-io/valkey-glide/pull/TBD))
