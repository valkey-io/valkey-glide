...
* Core/FFI: `create_client_from_uri` now preserves a URI username without a password to enable IAM authentication ([#7193](https://github.com/valkey-io/valkey-glide/pull/7193))
