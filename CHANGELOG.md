...
* Python: Raise `ConfigurationError` when `cert_reload_interval_seconds` is combined with byte-based mTLS instead of silently discarding the interval ([#6668](https://github.com/valkey-io/valkey-glide/issues/6668))
