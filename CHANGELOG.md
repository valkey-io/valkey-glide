...
* Core, Go: Use uint32 for Go BackoffStrategy fields and harden reconnect RetryStrategy against out-of-range values ([#6680](https://github.com/valkey-io/valkey-glide/pull/6680))
