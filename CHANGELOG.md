...
* Python: Propagate active OpenTelemetry parent span context to native command, batch and script spans ([#7069](https://github.com/valkey-io/valkey-glide/pull/7069))
