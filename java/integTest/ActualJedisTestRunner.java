...
/**
 * Test runner that uses actual Jedis client to generate expected results for comparison with GLIDE
 * Jedis compatibility layer.
 *
 * <p>This class can be run separately with actual Jedis on the classpath to generate expected
 * behavior that can be compared with GLIDE results.
 */
