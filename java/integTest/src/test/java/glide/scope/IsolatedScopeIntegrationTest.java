...
public class IsolatedScopeIntegrationTest {
    ...
    public void testScopeAcquireAndBasicCommands() throws Exception {
        ...
        IsolatedScope scope = client.scopedConnection(Duration.ofSeconds(10)).get(10, TimeUnit.SECONDS);
        assertNotNull(scope);
    ...
    public void testScopeIsolation() throws Exception {
        ...
        IsolatedScope scope1 =
                client.scopedConnection(Duration.ofSeconds(10)).get(10, TimeUnit.SECONDS);
        IsolatedScope scope2 =
                client.scopedConnection(Duration.ofSeconds(10)).get(10, TimeUnit.SECONDS);

        // Both scopes should have different scope IDs (different connections)
        assertNotEquals(
                scope1.getScopeId(), scope2.getScopeId(), "Two scopes should use different connections");
    ...
    public void testConcurrentScopeAcquisition() throws Exception {
            ...
            new Thread(
                            () -> {
                                try {
                                    ...
                                    IsolatedScope scope =
                                            client.scopedConnection(Duration.ofSeconds(15)).get(15, TimeUnit.SECONDS);
        ...
        client.close();
        System.out.println(
                "Concurrent scope acquisition test PASSED! "
                        + numThreads
                        + "/"
                        + numThreads
