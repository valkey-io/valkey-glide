...
public class TransactionTestUtilities {
    ...
    private static Object[] listCommands(BaseTransaction<?> transaction) {
        ...
        String listKey8 = "{ListKey}-8-" + UUID.randomUUID();
...
//                .lpos(listKey1, value1)
                ...
                //lposCount(listKey1, value1, 2L, LPosOptions.builder().rank(2L).build())
...
//                .lrange(listKey5, 0, -1)
                .rpush(listKey8, new String[] {value1, value1, value2, value3, value3})
                .lpos(listKey8, value1);
...
//                    new Long[] {0L}, // lposCount(listKey1, value1, 1L)
                   // new Long[] {0L, 1L}, // lposCount(listKey1, value1, 2L, LPosOptions.builder().rank(2L).build())
