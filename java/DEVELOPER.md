...
The Valkey GLIDE Java wrapper consists of both Java and Rust code. This implementation uses direct JNI (Java Native Interface) calls for high-performance communication between Java and Rust. Rust bindings for the Java Native Interface are implemented using [jni-rs](https://github.com/jni-rs/jni-rs), and the Java JAR is built using [Gradle](https://github.com/gradle/gradle). This JNI implementation provides 2x+ performance improvement over the legacy UDS (Unix Domain Socket) implementation.
