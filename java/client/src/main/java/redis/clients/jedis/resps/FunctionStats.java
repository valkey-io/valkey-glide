    ...
    public static final Builder<FunctionStats> FUNCTION_STATS_BUILDER =
            new Builder<FunctionStats>() {
                ...
                public FunctionStats build(Object data) {
                            ...
                            switch (BuilderFactory.STRING.build(kv.getKey())) {
                                ...
                                case "engines":
                                    ...
                                    for (KeyValue ikv : (List<KeyValue>) kv.getValue()) {
                                        enginesMap.put(
                                                BuilderFactory.STRING.build(ikv.getKey()),
                    ...
                    Map<String, Object> runningScriptMap =
                            list.get(1) == null ? null : BuilderFactory.ENCODED_OBJECT_MAP.build(list.get(1));
                    ...
                    for (int i = 0; i < enginesList.size(); i += 2) {
                        enginesMap.put(
                                BuilderFactory.STRING.build(enginesList.get(i)),
