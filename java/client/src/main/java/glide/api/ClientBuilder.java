...
/**
 * ClientBuilder provides a bridge between the legacy UDS-based client creation and the new
 * JNI-based implementation. This class handles the creation of native client handles and wraps them
 * in ClientParams for the new JNI constructors.
 */
public class ClientBuilder {
    ...
    /**
     * Create a ClientBuilder from a configuration. This internally creates the JNI native client.
     *
    ...
    public BaseClient.ClientParams toClientParams() {
        return new BaseClient.ClientParams(
                nativeHandle, maxInflight, requestTimeout, subscriptionConfiguration);
    }
