 ...
 *
 * <p>HPEXPIREAT sets expiration times for hash fields at a specific Unix timestamp in milliseconds
 * and supports only expiration conditions:
 *
 * <ul>
 ...
 * long unixTimestampMs = System.currentTimeMillis() + 3600000; // 1 hour from now
 * Long[] result = client.hpexpireat("myHash", unixTimestampMs, fields, options).get();
 *
 * // Set expiration only if new expiration is greater than current
 * HPExpireAtOptions gtOptions = HPExpireAtOptions.builder()
 *     .onlyIfGreaterThanCurrent()
 *     .build();
 *
 * Long[] gtResult = client.hpexpireat("myHash", unixTimestampMs + 3600000, fields, gtOptions).get();
 * }</pre>
 *
 * @since Valkey 9.0.0
...
@EqualsAndHashCode
@ToString
public final class HPExpireAtOptions {
    ...
    /** Builder class for {@link HPExpireAtOptions}. */
    public static class HPExpireAtOptionsBuilder {
         ...
         */
        public HPExpireAtOptionsBuilder onlyIfNoExpiry() {
         ...
         * @return This builder instance
         */
        public HPExpireAtOptionsBuilder onlyIfHasExpiry() {
         ...
         * @return This builder instance
         */
        public HPExpireAtOptionsBuilder onlyIfGreaterThanCurrent() {
         ...
         * @return This builder instance
         */
        public HPExpireAtOptionsBuilder onlyIfLessThanCurrent() {
