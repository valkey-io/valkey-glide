 ...
 *
 * <p><b>Promptness:</b> Implementations must return promptly. This callback is invoked on the
 * reconnection path; a slow or blocking implementation (e.g., an unbounded network request to Vault
 * or STS) will directly extend failover time with no indication to the caller.
 *
 * @see AwsCredentials
