...
public abstract class BaseClientConfiguration {
    ...
    /**
     * lazyConnect boolean: Enables lazy connection mode, where physical connections to the server(s)
     ...
     *
     * <p>When set to `True`, the client will not attempt to connect to the specified nodes during
