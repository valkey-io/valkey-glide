 ...
 *
 * <p>HEXPIRE sets expiration times for hash fields and supports only expiration conditions:
 *
 * <ul>
 ...
 *     .build();
 *
 * Long[] gtResult = client.hexpire("myHash", 120, fields, gtOptions).get();
 * }</pre>
 *
 * @since Valkey 9.0.0
...
@EqualsAndHashCode
@ToString
public final class HExpireOptions {
    ...
    /** Builder class for {@link HExpireOptions}. */
    public static class HExpireOptionsBuilder {
         ...
         */
        public HExpireOptionsBuilder onlyIfNoExpiry() {
         ...
         * @return This builder instance
         */
        public HExpireOptionsBuilder onlyIfHasExpiry() {
         ...
         * @return This builder instance
         */
        public HExpireOptionsBuilder onlyIfGreaterThanCurrent() {
         ...
         * @return This builder instance
         */
        public HExpireOptionsBuilder onlyIfLessThanCurrent() {
