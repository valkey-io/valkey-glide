 ...
 * 2. The result of the {@link GenericClusterCommands#scan} call returns a cursor at <code>index 0</code> of the returned
 * <code>Object[]</code>. This cursor can be supplied again to a call to {@link GenericClusterCommands#scan}, provided
 * {@link #isFinished()} returns false.
 * <p>
 * Note that cursors returned by {@link GenericClusterCommands#scan} may hold external resources. These resources can
 * be released by calling {@link #releaseCursorHandle()}. However doing so will disallow the cursor from being used
 * in {@link GenericClusterCommands#scan} to get more data.
 * <p>
...
public interface ClusterScanCursor {
     ...
     * <p>
     * If this method returns false, this cursor instance should get passed to
     * {@link GenericClusterCommands#scan}
     * to get next set of data.
     *
     * @return true if this cursor is the last set of data. False if there is potentially more data available.
     */
    boolean isFinished();
     ...
     * <p>
     * This method can be called to immediately release resources tied to this cursor instance. Note that if this
     * is called, this cursor cannot be used in {@link GenericClusterCommands#scan}. Also, this method is optional for
     * the caller. If it does not get called, cursor resources will be freed during garbage collection.
     */
    void releaseCursorHandle();

    /**
     * The special cursor used to start the first in a series of {@link GenericClusterCommands#scan} calls.
     */
