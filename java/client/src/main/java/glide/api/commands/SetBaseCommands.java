...
public interface SetBaseCommands {
     ...
     * @apiNote If <code>key</code> does not exist, a new set is created before adding <code>members
     *     </code>.
     * @example
     *     <pre>{@code
     ...
     * @apiNote If <code>key</code> does not exist, it is treated as an empty set and this command
     *     returns <code>0</code>.
     * @example
     *     <pre>{@code
     ...
     * @apiNote If <code>key</code> does not exist an empty set will be returned.
     * @example
     *     <pre>{@code
