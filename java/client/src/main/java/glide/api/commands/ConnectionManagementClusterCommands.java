...
public interface ConnectionManagementClusterCommands {
     ...
     * @example
     *     <pre>{@code
     * String response = clusterClient.clientReply("ON").get();
     * assert response.equals("OK");
     * }</pre>
     */
     ...
     * @example
     *     <pre>{@code
     * String response = clusterClient.clientReply("ON", ALL_NODES).get();
     * assert response.equals("OK");
     * }</pre>
     */
    CompletableFuture<String> clientReply(String mode, Route route);
