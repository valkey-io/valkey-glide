 ...
 * 5. DirectByteBuffer support for large responses (>16KB)
 */
public final class AsyncRegistry {
     ...
     * Supports both regular Java objects and DirectByteBuffer for large responses (>16KB).
     */
    public static boolean completeCallback(long correlationId, Object result) {
        ...
        if (result instanceof ByteBuffer) {
            ...
            if (buffer.isDirect()) {
                System.getLogger("glide.performance").log(
