...
/**
 * Routing information for command execution in cluster environments.
 * Supports all glide-core routing strategies including automatic, explicit node targeting,
 * slot-based routing, and multi-node operations.
 */
public class RouteInfo {
    ...
    private RouteInfo(RouteType routeType, String slotKey, Integer slotId, String host, Integer port, Boolean preferReplica) {
