...
/**
 * Stub MessageHandler implementation for JNI-based clients. This is a minimal implementation to
 * prevent crashes until full PubSub support is implemented.
 */
public class MessageHandler {

    private final PubSubMessageQueue messageQueue;
    private final Optional<
                    glide.api.models.configuration.BaseSubscriptionConfiguration.MessageCallback>
            callback;
    private final Optional<Object> context;

    public MessageHandler(
            Optional<glide.api.models.configuration.BaseSubscriptionConfiguration.MessageCallback>
                    callback,
            Optional<Object> context,
            BaseResponseResolver resolver) {
    ...
    /** PubSub message queue implementation. This is a stub implementation for now. */
