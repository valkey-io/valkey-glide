...
public class AsyncRegistryTest {
    ...
    void failAllWithError_completesAllPendingFutures() {
        ...
        AsyncRegistry.register(f1, 0, 1L);
        AsyncRegistry.register(f2, 0, 1L);
        AsyncRegistry.register(f3, 0, 1L);

        assertEquals(3, AsyncRegistry.getPendingCount());
    ...
    void failAllWithError_clearsInflightCounters() {
        ...
        AsyncRegistry.register(f1, 1, 42L);
