...
public class HashFieldExpirationConditionOptionsTest {
    ...
    public void testThreadSafety_immutability() {
        ...
        HashFieldExpirationConditionOptions options1 = builder1.condition(ExpireOptions.HAS_NO_EXPIRY).build();
        HashFieldExpirationConditionOptions options2 = builder1.condition(ExpireOptions.HAS_EXISTING_EXPIRY).build();
