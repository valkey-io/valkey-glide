...
public final class SearchBuilderFactory {
    ...
    public static final Builder<Map<String, Object>> SEARCH_PROFILE_PROFILE =
            new Builder<Map<String, Object>>() {
                    ...
                    for (Object listObject : list) {
                        ...
                        if (attributeList.size() == 2) {
                            ...
                            if (attributeName.equals(RESULT_PROCESSORS_PROFILE_STR)) {
                                List<Map<String, Object>> resultProcessorsProfileList =
                                        new ArrayList<>(attributeList.size() - 1);
                ...
                private Object parseIterators(Object data) {
                    ...
                    // https://github.com/RediSearch/RediSearch/issues/3205 patch. TODO: Undo if resolved in
                    // RediSearch.
                    ...
                    if (childIteratorsIndex + 1 < iteratorsAttributeList.size()) {
                        List childIteratorsList =
                                new ArrayList(iteratorsAttributeList.size() - childIteratorsIndex - 1);
    ...
    public static final Builder<Map<String, List<String>>> SEARCH_SYNONYM_GROUPS =
            new Builder<Map<String, List<String>>>() {
                @Override
                ...
                public Map<String, Map<String, Double>> build(Object data) {
                    ...
                    for (Object rawTerm : rawTerms) {
                        ...
                        list.forEach(
                                entry ->
                                        entries.put(
                                                STRING.build(entry.get(1)), BuilderFactory.DOUBLE.build(entry.get(0))));
