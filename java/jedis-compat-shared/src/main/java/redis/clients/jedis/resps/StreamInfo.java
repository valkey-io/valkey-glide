...
/**
 * This class holds information about stream. They can be accessed via getters. There is also {@link
 * StreamInfo#getStreamInfo} method that returns a generic {@code Map} in case more info are
