 ...
 */
public abstract class AbstractZParams<T extends AbstractZParams<T>> {
     ...
     * @return ZParams
     */
    public T weights(final double... weights) {
     ...
     * @return ZParams
     */
    public T aggregate(final Aggregate aggregate) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractZParams<?> that = (AbstractZParams<?>) o;
        return Objects.equals(weightsList, that.weightsList) && aggregate == that.aggregate;
    }
