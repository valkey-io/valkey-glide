...
public abstract class AbstractGlideJedis extends JedisCommon {
    ...
    private Pool
            dataSource; // Following original Jedis pattern; raw type for Pool<Jedis> at call sites
     ...
     */
    protected AbstractGlideJedis(String host, int port) {
     ...
     */
    protected AbstractGlideJedis(String host, int port, boolean useSsl) {
     ...
     */
    protected AbstractGlideJedis(String host, int port, int timeout) {
        this(
                host,
                port,
                DefaultJedisClientConfig.builder()
     ...
     * @param config the jedis client configuration
     */
    protected AbstractGlideJedis(HostAndPort hostAndPort, JedisClientConfig config) {
     ...
     */
    @SuppressWarnings("rawtypes")
    protected void setDataSource(Pool jedisPool) {
