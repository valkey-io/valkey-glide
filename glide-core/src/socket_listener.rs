...
// The cleanup_socket_files function has been removed as it was too aggressive
// and could interfere with other running clients. Socket files are now cleaned up
// automatically when clients are properly closed through the existing mechanisms
// in close_socket() and the socket listener shutdown code.
