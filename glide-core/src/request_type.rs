...
pub enum RequestType {
    ...
    UnsubscribeLazy = 915,
    PSubscribeLazy = 916,
    PUnsubscribeLazy = 917,
    SSubscribeLazy = 918,
    SUnsubscribeLazy = 919,
...
impl From<::protobuf::EnumOrUnknown<ProtobufRequestType>> for RequestType {
    fn from(value: ::protobuf::EnumOrUnknown<ProtobufRequestType>) -> Self {
        match value.enum_value_or(ProtobufRequestType::InvalidRequest) {
            ...
            ProtobufRequestType::SubscribeLazy => RequestType::SubscribeLazy,
            ProtobufRequestType::UnsubscribeLazy => RequestType::UnsubscribeLazy,
            ProtobufRequestType::PSubscribeLazy => RequestType::PSubscribeLazy,
            ProtobufRequestType::PUnsubscribeLazy => RequestType::PUnsubscribeLazy,
            ProtobufRequestType::SSubscribeLazy => RequestType::SSubscribeLazy,
            ProtobufRequestType::SUnsubscribeLazy => RequestType::SUnsubscribeLazy,
...
impl RequestType {
    ...
    pub fn get_command(&self) -> Option<Cmd> {
        match self {
            ...
            RequestType::SubscribeLazy => Some(cmd("SUBSCRIBE_LAZY")),
            RequestType::UnsubscribeLazy => Some(cmd("UNSUBSCRIBE_LAZY")),
            RequestType::PSubscribeLazy => Some(cmd("PSUBSCRIBE_LAZY")),
            RequestType::PUnsubscribeLazy => Some(cmd("PUNSUBSCRIBE_LAZY")),
            RequestType::SSubscribeLazy => Some(cmd("SSUBSCRIBE_LAZY")),
            RequestType::SUnsubscribeLazy => Some(cmd("SUNSUBSCRIBE_LAZY")),
